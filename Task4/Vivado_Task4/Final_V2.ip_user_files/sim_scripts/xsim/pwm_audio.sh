...
#
# Script generated by Vivado on Mon Apr 14 16:10:20 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pwm_audio.sh
...
#
# Usage        : pwm_audio.sh
#                pwm_audio.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pwm_audio.sh [-reset_run]
#                pwm_audio.sh [-reset_log]
#                pwm_audio.sh [-help]
#
...
# script info
echo -e "pwm_audio.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pwm_audio.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L xilinx_vip -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot pwm_audio xil_defaultlib.pwm_audio xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pwm_audio -key {Behavioral:sim_1:Functional:pwm_audio} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pwm_audio.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pwm_audio.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pwm_audio.sh [-help]\n\
Usage: pwm_audio.sh [-step]\n\
Usage: pwm_audio.sh [-lib_map_path]\n\
Usage: pwm_audio.sh [-reset_run]\n\
Usage: pwm_audio.sh [-reset_log]\n\
Usage: pwm_audio.sh [-keep_index]\n\
Usage: pwm_audio.sh [-noclean_files]\n\n\
