# 0 "C:\\Users\\harsh\\Downloads\\SoCFinalProject\\Task4\\Vitis_Task4\\platform\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:\\Users\\harsh\\Downloads\\SoCFinalProject\\Task4\\Vitis_Task4\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\harsh\\Downloads\\SoCFinalProject\\Task4\\Vitis_Task4\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
  ...
  microblaze_riscv_0: cpu@0 {
   ...
   xlnx,use-icache = <0>;
   d-cache-size = <8192>;
   xlnx,memory-ip-list = "microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory" , "microblaze_riscv_0_local_memory_ilmb_bram_if_cntlr_memory" , "axi_bram_ctrl_1_memory";
   xlnx,async-wakeup = <3>;
 ...
 amba_pl: amba_pl {
  ...
  #address-cells = <1>;
  #size-cells = <1>;
  axi_bram_ctrl_0: axi_bram_ctrl@40020000 {
   xlnx,protocol = "AXI4";
  ...
  axi_bram_ctrl_1: axi_bram_ctrl@c0000000 {
   xlnx,protocol = "AXI4";
   xlnx,edk-special = "BRAM_CTRL";
   compatible = "xlnx,axi-bram-ctrl-4.1";
   xlnx,ecc-onoff-reset-value = <0>;
  ...
  myip_pong2_0: myip_pong2_Edit1@44a00000 {
   xlnx,rable = <0>;
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,myip-pong2-Edit1-1.0";
   status = "okay";
   xlnx,s00-axi-addr-width = <4>;
   xlnx,ip-name = "myip_pong2_Edit1";
   xlnx,edk-iptype = "PERIPHERAL";
...
# 3 "C:\\Users\\harsh\\Downloads\\SoCFinalProject\\Task4\\Vitis_Task4\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7s50";
 #address-cells = <1>;
 #size-cells = <1>;
 ...
 axi_bram_ctrl_1_memory: memory@c0000000 {
  compatible = "xlnx,axi-bram-ctrl-4.1";
  xlnx,ip-name = "axi_bram_ctrl";
  device_type = "memory";
  memory_type = "memory";
 ...
 microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory: memory@2000 {
  compatible = "xlnx,lmb-bram-if-cntlr-4.0";
 ...
 cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
  address-map = <0xC0000000 &axi_bram_ctrl_1_memory 0xC0000000 0x10000>,
         <0xC0000000 &axi_bram_ctrl_1 0xC0000000 0x10000>,
         <0x00002000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory 0x00002000 0x20000>,
         <0x00002000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr 0x00002000 0x20000>,
