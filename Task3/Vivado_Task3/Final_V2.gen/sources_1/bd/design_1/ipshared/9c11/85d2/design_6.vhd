...
architecture STRUCTURE of design_6 is
  signal Pong_Top2_0_o_P1_Score_Pulse : STD_LOGIC; -- Alex Villegas
  signal Pong_Top2_0_o_P2_Score_Pulse : STD_LOGIC; -- Alex Villegas
  signal Pong_Top2_0_o_Paddle_Bounce_Pulse : STD_LOGIC;  -- Alex Villegas
...
Pong_Top2_0: component design_6_Pong_Top2_0_0
     port map (
      ...
      o_P1_Score_Pulse => Pong_Top2_0_o_P1_Score_Pulse, --Alex Villegas
      o_P2_Score_Pulse => Pong_Top2_0_o_P2_Score_Pulse,  --Alex Villegas
      o_Paddle_Bounce_Pulse => Pong_Top2_0_o_Paddle_Bounce_Pulse
    );
...
-- Connect internal score pulses to top-level outputs
o_P1_Score_Pulse <= Pong_Top2_0_o_P1_Score_Pulse;
o_P2_Score_Pulse <= Pong_Top2_0_o_P2_Score_Pulse;
o_Paddle_Bounce_Pulse <= Pong_Top2_0_o_Paddle_Bounce_Pulse;
