...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L util_vector_logic_v2_0_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_6 xil_defaultlib.design_6 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_6 -key {Behavioral:sim_1:Functional:design_6} -tclbatch cmd.tcl -protoinst "protoinst_files/design_6.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_6.wdb xsim.dir libdpi.so)
