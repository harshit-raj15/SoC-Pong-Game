...
#
# Script generated by Vivado on Thu Jan 23 13:00:25 EST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_6.sh
...
#
# Usage        : design_6.sh
#                design_6.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_6.sh [-reset_run]
#                design_6.sh [-reset_log]
#                design_6.sh [-help]
#
...
#                script (type 'design_6.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname util_vector_logic_v2_0_4 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib util_vector_logic_v2_0_4)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "design_6.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_6.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../edit_myip_pong2_v1_0.gen/sources_1/bd/design_6/ipshared/3cbc" \
  ...
  xmvlog -work util_vector_logic_v2_0_4 $xmvlog_opts +incdir+"../../../../edit_myip_pong2_v1_0.gen/sources_1/bd/design_6/ipshared/3cbc" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../edit_myip_pong2_v1_0.gen/sources_1/bd/design_6/ipshared/3cbc" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.design_6 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.design_6 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log design_6_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_6.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_6.sh [-help]\n\
Usage: design_6.sh [-step]\n\
Usage: design_6.sh [-lib_map_path]\n\
Usage: design_6.sh [-reset_run]\n\
Usage: design_6.sh [-reset_log]\n\
Usage: design_6.sh [-keep_index]\n\
Usage: design_6.sh [-noclean_files]\n\n\
