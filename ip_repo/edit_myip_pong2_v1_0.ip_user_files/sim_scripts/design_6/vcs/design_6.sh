...
design_libs=(xpm xil_defaultlib util_vector_logic_v2_0_4)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../edit_myip_pong2_v1_0.gen/sources_1/bd/design_6/ipshared/3cbc" \
  ...
  vlogan -work util_vector_logic_v2_0_4 $vlogan_opts +v2k +incdir+"../../../../edit_myip_pong2_v1_0.gen/sources_1/bd/design_6/ipshared/3cbc" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../edit_myip_pong2_v1_0.gen/sources_1/bd/design_6/ipshared/3cbc" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.design_6 xil_defaultlib.glbl -o design_6_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./design_6_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key design_6_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc design_6_simv.daidir vcs_lib c.obj)
